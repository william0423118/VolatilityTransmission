function [Final_Shock Shock_TS]=maketable(Shock_AS,Shock_EU,Shock_NA,Shock_NO,Alldata1)
...
Final_Shock=[ret(1,[3:8,1:2,1 4 6]);zeros(1,11);Shock_Trans;zeros(2,11);Shock_Rec; ...
